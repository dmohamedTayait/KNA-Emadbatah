        ...
        public static string GetAutomaticSessionStartText(long sessionID)
        {
           ...
           if (att != null)
           {
            ...
            else
            {
                ...
                body += "<div style='font-weight:bold;font-size:14pt;line-height:150%;text-align:right;direction:rtl; text-align: right;font-family:AdvertisingBold'>" + docStartNotOnTime + "</div>";
                body += "<br/>";
                body += "<br/>";
            ...
            madbatahStart += "<div style='font-weight:bold;font-size:14pt;line-height:150%;text-align:right;direction:rtl; text-align: right;font-family:AdvertisingBold'>" + madbatahStartsection2 + "</div><br/><br/>";
        ...
        public static string writeAttendantNFile(string head, List<Attendant> attendants)
        {
            ...
            if (attendants.Count > 0)
            {
                ...
                foreach (Attendant att in attendants)
                {
                    ...
                    {
                        body += "<tr><td style='font-weight:bold;font-size:14pt;line-height:150%;text-align:right;direction:rtl; text-align: right;font-family:AdvertisingBold; text-justify:kashida;'>" + " - " + att.Name.Trim() + "</td></tr>";
