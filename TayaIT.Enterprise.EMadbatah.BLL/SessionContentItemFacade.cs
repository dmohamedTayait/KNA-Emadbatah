...
namespace TayaIT.Enterprise.EMadbatah.BLL
{
    public class SessionContentItemFacade
    {
        ...
        public static int UpdateSessionContentItem(long sessionContentItemID, string text, long attendantID, long agendaItemID, long? agendaSubItemID, string commentsOnAttendant, string commentsOnText, string FooterText, Model.SessionContentItemStatus status, bool mergedWithPrev, bool ignored, long attachID, int voteID, int isSessionPresident)
        {
            return SessionContentItemHelper.UpdateSessionContentItem(sessionContentItemID, text, attendantID, agendaItemID, agendaSubItemID, commentsOnAttendant, commentsOnText, FooterText, (int)status, mergedWithPrev, ignored, attachID, voteID, isSessionPresident);
        }
