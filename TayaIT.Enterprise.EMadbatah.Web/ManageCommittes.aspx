<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageCommittes.aspx.cs" Inherits="TayaIT.Enterprise.EMadbatah.Web.ManageCommittes"
...
<div class="grid_24 xxlargerow">
    ...
    <div id="datacont1" class="datacont1 largerow">
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tbody id="db_committees" runat="server">
                <!-- <tr>
                        <td>
                            محمد عبد اللطيف
                        </td>
    ...
    <div class="drow">
        <div class="addnewusercont fr">
            <a href="#" class="actionbtnsmenu AddNewCommittee">إضافة لجنة جديدة </a>
        </div>
