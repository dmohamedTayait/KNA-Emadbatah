...
namespace TayaIT.Enterprise.EMadbatah.Web
{
    public class BasePage : Page
    {
        ...
        protected override void InitializeCulture()
        {
            ...
            CurrentUser = EMadbatahFacade.GetUserByUserID(138); //EMadbatahFacade.GetUserByDomainUserName(testUser);138// EMadbatahFacade.GetUserByUserID(92);// //id.Name.ToLower());
/*
