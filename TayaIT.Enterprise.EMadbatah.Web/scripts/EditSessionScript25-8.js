...
$(document).ready(function() {
 // select tag
    ...
    $(".split").click(function () {
        ...
        if (isBlock) {
            var lastElement = $rangeStart.nextAll().last();
        ...
        if (ed.contentDocument.body.firstChild == ed.selection.getStart() && ed.contentDocument.body.lastChild == ed.selection.getEnd()) {
            // alert the user
        ...
        success: function(response) {
            if (response != '') {
                ...
                $(listData).delegate('li','click',function(){
                    ...
                    if (((nodeName == 'SPAN' || nodeName == 'P')) && (tintMceActive.getRng().startOffset == 0 || ed.selection.getRng().startOffset == ed.selection.getRng().endOffset)) {
