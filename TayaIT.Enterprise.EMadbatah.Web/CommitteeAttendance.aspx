        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="grid_16">
                    ...
                    <div class="largerow">
                        <asp:GridView ID="GVDefaultAttendants" runat="server" CssClass="table" orderWidth="0"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="<span class='space-st1'>غائب</span><span class='space-st1'>غائب بعذر</span>">
                                    <ItemTemplate>
